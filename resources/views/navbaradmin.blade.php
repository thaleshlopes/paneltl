  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li @if($current=="usuarios") class="active" else class="" @endif>
          <a href="/usuarios"><i class="fa fa-link"></i> <span>Usuários</span></a>
        </li>
        ...
        <li @if($current=="gravador") class="active" else class="" @endif>
          <a href="/gravador"><i class="fa fa-youtube-play"></i> <span>Gravador</span></a>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
